	...
	function (require, exports, module) {
		...
		var PgsqlHighlightRules = function () {
			var keywords =
				...
				"BIGINT|BINARY|BIT|BOOL|BOOLEAN|BOTH|BOX|BPCHAR|BUFFERS|BY|BYTEA|CACHE|CALLED|CASCADE|CASCADED|CASE|CAST|" +
				...
				"FAMILY|FDW_HANDLER|FETCH|FIRST|FLOAT|FLOAT4|FLOAT8|FOLLOWING|FOR|FORCE|FOREIGN|FORMAT|FORWARD|" +
